...
The image includes Node 22, Node-RED with node-red-agents, Pi, Claude Code, Codex, OpenCode, GitHub CLI, and sandbox-runtime tooling.
...
Run `make release BUMP=major|minor|patch` from a clean tree to tag, release, and push.
